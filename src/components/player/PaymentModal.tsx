        ...
        {paid ? (
          ...
          <>
            <div>
              ...
              <p className="text-gray-500 text-sm mt-1">Selecione um plano</p>
            </div>
                          ...
                          >
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center gap-2">
                                ...
                                {opt.badge && <span className="text-[9px] font-black px-1.5 py-0.5 rounded-full text-white" style={{ background: isVitalicio ? 'linear-gradient(135deg,#CA8A04,#EAB308)' : 'linear-gradient(135deg,#FF6A00,#FF8533)' }}>{opt.badge}</span>}
                              </div>
                            ...
                            <div className="mt-1 mx-1 rounded-xl px-3 py-2.5 space-y-1" style={{ background: isVitalicio ? 'rgba(234,179,8,0.07)' : 'rgba(255,106,0,0.07)', border: `1px solid ${isVitalicio ? 'rgba(234,179,8,0.2)' : 'rgba(255,106,0,0.2)'}` }}>
                              {opt.benefits.map((b, i) => (
                                <div key={i} className="flex items-center gap-2 text-xs text-gray-300">
                                  <span className={`font-bold ${isVitalicio ? 'text-yellow-400' : 'text-orange-400'}`}>✓</span><span>{b}</span>
                                </div>
                              ))}
                            </div>
                          )}
